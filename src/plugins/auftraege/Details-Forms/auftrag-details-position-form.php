            ...
            <div class="tab-content" id="tab-content-name">
                <div class="tab-pane fade show active" id="tab-content-name-1">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group form-floating">
                                <input type="text" name="menge" data-role="menge" value="1" class="form-control editable" placeholder="Menge" required>
                                <label>Menge</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group form-floating label-info">
                                <input type="text" name="vk" data-role="vk" value="90" class="form-control editable" placeholder="Netto">
                                <label>VK Netto</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group form-floating">
                                <input type="text" name="steuer_satz" data-role="steuer_satz" class="form-control editable" data-unit="%" placeholder="Steuer" value="19,0">
                                <label>Steuer</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <br>
                            <span class="badge bg-info">EK > VK</span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 rabatt-is-checked">
                            <div class="form-group form-floating label-warning">
                                <input type="text" name="rabatt_wert" data-role="rabatt_wert" class="form-control editable" placeholder="rabatt_wert">
                                <label>Wert</label>
                            </div>
                        </div>
                        <div class="col-md-3 rabatt-is-checked">
                            <div class="form-group form-floating label-warning">
                                <input type="text" name="vk_inkl_rabatt" data-role="vk_inkl_rabatt" class="form-control editable" placeholder="VK Rabatt">
                    ...
                    <div class="row rabatt-is-checked">
                        ...
                        <div class="col-md-3">
                            <div class="form-group form-floating label-warning">
                                <input type="text" name="marge_wert_inkl_rabatt" data-role="marge_wert_inkl_rabatt" class="form-control editable" placeholder="Netto">
                                <label>Marge Rabatt</label>
                            </div>
                        </div>
                        <div class="col-md-3"></div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group form-floating">
                                <input type="text" name="ek" data-role="ek" value="57,00" class="form-control editable" placeholder="Netto">
                                <label>EK Netto</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group form-floating">
                                <input type="text" name="marge_prozent" data-role="marge_prozent" data-unit="%" class="form-control editable" placeholder="Netto">
                                <label>Marge %</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group form-floating">
                                <input type="text" name="marge_wert" data-role="marge" class="form-control editable" placeholder="Netto">
                                <label>Marge</label>
                            </div>
                        </div>
                    ...
                    <div class="row rabatt-is-not-checked">
                        <div class="col-md-3">
                            <div class="form-group form-floating">
                                <input type="text" name="netto_gesamt" data-role="netto_gesamt" class="form-control editable" placeholder="Netto" value="" disabled>
                                <label>Netto</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group form-floating">
                                <input type="text" name="steuer_wert_gesamt" data-role="steuer_wert_gesamt" class="form-control editable" placeholder="MwSt." value="" disabled>
                                <label>MwSt.</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group form-floating">
                                <input type="text" name="brutto_gesamt" data-role="brutto_gesamt" class="form-control editable" placeholder="Brutto" value="" disabled>
                                <label>Brutto</label>
                            </div>
                        </div>
                    </div>
                    <div class="row rabatt-is-checked">
                        ...
                        <div class="col-md-3">
                            <div class="form-group form-floating label-warning">
                                <input type="text" name="steuer_wert_inkl_rabatt_gesamt" data-role="steuer_wert_inkl_rabatt_gesamt" class="form-control editable" placeholder="MwSt." value="" disabled>
                                <label>MwSt.</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group form-floating label-warning">
                                <input type="text" name="brutto_inkl_rabatt_gesamt" data-role="brutto_inkl_rabatt_gesamt" class="form-control editable" placeholder="Brutto" value="" disabled>
                                <label>Brutto</label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="tab-content-name-3">
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group form-floating-radio">
                            <label class="form-label">Rabatt Darstellung</label>
                            <div class="form-radio">
                                <input type="radio" class="form-check-input editable" id="pos-rabatt-darstellung-1" name="pos_rabatt_darstellung" value="1" />
                                <label class="form-check-label" for="pos-rabatt-darstellung-1">in Prozent</label>
                            </div>
                            <div class="form-radio">
                                <input type="radio" class="form-check-input editable" id="pos-rabatt-darstellung-2" name="pos_rabatt_darstellung" value="2" />
                                <label class="form-check-label" for="pos-rabatt-darstellung-2">als Betrag</label>
                            </div>
                            <div class="form-radio">
                                <input type="radio" class="form-check-input editable" id="pos-rabatt-darstellung-3" name="pos_rabatt_darstellung" value="3" />
                                <label class="form-check-label" for="pos-rabatt-darstellung-3">Beides</label>
                            </div>
                        </div>
                ...
                <button type="button" class="btn btn-primary btn-positionen-speichern mt-3"><i class="fa-solid fa-save"></i> Speichern</button>
