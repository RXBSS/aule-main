 ...
 * 
 */
class AuftragsbestaetigungDoc extends Document {
    ...
    // Daten für Auftragsbestätigung auslesen
    function getData() {
        ...
        // Daten 
        $this->data = $auftrag->get($this->id)['data'];
        ...
        // Positionen Summe
        $this->data['positionen_summe'] = $auftrag->pos->getSum($this->id)['data'];

        // Positionen 
        $this->data['positionen'] = $auftrag->pos->getAllById($this->id)['data'];
    }
    ...
    function build() {
        ...
        $list = [
            ...
            ['<br>'],
            ['Liefertermin', $this->data['liefertermin']->format('d.m.Y')],
        ];
        ...
        $this->standardHead(1, $this->data['rechnungsanschrift_id'], $list, "AB-" . $this->data['id']);

        // Name der Rechnung
        $this->writeHeadline('Auftragsbestätigung');
